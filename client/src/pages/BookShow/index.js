...
import StripeCheckout from "react-stripe-checkout"; // You cannot accept payments using this API as it is no longer supported in India. Please refer to https://stripe.com/docs/payments for accepting payments.
        ...
        {selectedSeats.length > 0 && (
          <div className="mt-2 flex justify-center gap-2 items-center flex-col">
            ...
            <StripeCheckout
              ...
              billingAddress
              stripeKey="pk_test_51OxTIuSAR5llKIZ0paBDhZqIYUSGc28yvY8pXztHJOZfiUbpwDLrDt7bzKAl9ZE4uxnEFLB7EmWJQ3GBUGVogzgE00dwcW99m7"
            >
